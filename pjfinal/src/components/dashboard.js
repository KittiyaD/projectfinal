...
const Dashboard = (props) => {
  ...
  const [SeverityDirectoryUrlCritical, setSeverityDirectoryUrlCritical] =
    useState([]);
  ...
  const [SeverityHttponlyUrlCritical, setSeverityHttponlyUrlCritical] =
    useState([]);
  ...
  const [SeveritySentitiveUrlCritical, setSeveritySentitiveUrlCritical] =
    useState();
  const [SeveritySentitiveUrlHigh, setSeveritySentitiveUrlHigh] = useState();
  const [SeveritySentitiveUrlMedium, setSeveritySentitiveUrlMedium] =
    useState();
  ...
  const [SeverityCommandUrlCritical, setSeverityCommandUrlCritical] =
    useState();
  ...
  const fetchData = async () => {
    try {
      ...
      if (response.data[3].SeverityDirectory[0][0] === 0) {
        ...
        setSeverityDirectoryCritical(
          response.data[3].SeverityDirectory[0].length
        );
      ...
      if (response.data[3].SeverityDirectory[2][0] === 0) {
        ...
        setSeverityDirectoryMedium(
          response.data[3].SeverityDirectory[2].length
        );
      ...
      if (response.data[6].SeverityHttponly[0][0] === 0) {
        ...
        setSeverityHttponlyCritical(
          response.data[6].SeverityHttponly[0].length
        );
      ...
      if (response.data[14].SeveritySentitive[0][0] === 0) {
        ...
        setSeveritySentitiveCritical(
          response.data[14].SeveritySentitive[0].length
        );
      ...
      if (response.data[14].SeveritySentitive[2][0] === 0) {
        ...
        setSeveritySentitiveMedium(
          response.data[14].SeveritySentitive[2].length
        );
  ...
  const datanumber = [
    {
      ...
      c: [
        {
          name: "Critical",
          c: SeveritySQLCritical,
          url: SeveritySQLUrlCritical,
        },
    ...
    },
    {
      ...
      c: [
        {
          name: "Critical",
          c: SeverityXSSCritical,
          url: SeverityXSSUrlCritical,
        },
    ...
    },
    {
      ...
      c: [
        {
          name: "Critical",
          c: SeverityDirectoryCritical,
          url: SeverityDirectoryUrlCritical,
        },
        {
          name: "High",
          c: SeverityDirectoryHigh,
          url: SeverityDirectoryUrlHigh,
        },
        {
          name: "Medium",
          c: SeverityDirectoryMedium,
          url: SeverityDirectoryUrlMedium,
        },
    ...
    },
    {
      ...
      c: [
        {
          name: "Critical",
          c: SeveritySentitiveCritical,
          url: SeveritySentitiveUrlCritical,
        },
        {
          name: "High",
          c: SeveritySentitiveHigh,
          url: SeveritySentitiveUrlHigh,
        },
        {
          name: "Medium",
          c: SeveritySentitiveMedium,
          url: SeveritySentitiveUrlMedium,
        },
    ...
    },
    {
      ...
      c: [
        {
          name: "Critical",
          c: SeverityHSTSCritical,
          url: SeverityHSTSUrlCritical,
        },
    ...
    },
    {
      ...
      c: [
        {
          name: "Critical",
          c: SeveritySecureCritical,
          url: SeveritySecureUrlCritical,
        },
        { name: "High", c: SeveritySecureHigh, url: SeveritySecureUrlHigh },
        {
          name: "Medium",
          c: SeveritySecureMedium,
          url: SeveritySecureUrlMedium,
        },
    ...
    },
    {
      ...
      c: [
        {
          name: "Critical",
          c: SeverityHttponlyCritical,
          url: SeverityHttponlyUrlCritical,
        },
        { name: "High", c: SeverityHttponlyHigh, url: SeverityHttponlyUrlHigh },
        {
          name: "Medium",
          c: SeverityHttponlyMedium,
          url: SeverityHttponlyUrlMedium,
        },
    ...
    },
    {
      ...
      c: [
        {
          name: "Critical",
          c: SeverityExpiresCritical,
          url: SeverityExpiresUrlCritical,
        },
        { name: "High", c: SeverityExpiresHigh, url: SeverityExpiresUrlHigh },
        {
          name: "Medium",
          c: SeverityExpiresMedium,
          url: SeverityExpiresUrlMedium,
        },
    ...
    },
    {
      ...
      c: [
        {
          name: "Critical",
          c: SeveritySamesiteCritical,
          url: SeveritySamesiteUrlCritical,
        },
        { name: "High", c: SeveritySamesiteHigh, url: SeveritySamesiteUrlHigh },
        {
          name: "Medium",
          c: SeveritySamesiteMedium,
          url: SeveritySamesiteUrlMedium,
        },
    ...
    },
    {
      ...
      c: [
        {
          name: "Critical",
          c: SeverityServerCritical,
          url: SeverityServerUrlCritical,
        },
        { name: "High", c: SeverityServerHigh, url: SeverityServerUrlHigh },
        {
          name: "Medium",
          c: SeverityServerMedium,
          url: SeverityServerUrlMedium,
        },
    ...
    },
    {
      ...
      c: [
        {
          name: "Critical",
          c: SeverityWebCritical,
          url: SeverityWebUrlCritical,
        },
    ...
    },
    {
      ...
      c: [
        {
          name: "Critical",
          c: SeverityCommandCritical,
          url: SeverityCommandUrlCritical,
        },
        { name: "High", c: SeverityCommandHigh, url: SeverityCommandUrlHigh },
        {
          name: "Medium",
          c: SeverityCommandMedium,
          url: SeverityCommandUrlMedium,
        },
  ...
  const transformedData = datanumber.reduce((acc, category) => {
    category.c.forEach((subCategory, subIndex) => {
      ...
      if (existingEntry) {
        existingEntry[`value_${subCategory.name.toLowerCase()}`] =
          subCategory.c;
      } else {
        const newEntry = {
          name: key,
